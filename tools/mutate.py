...
TARGETS: dict[str, Target] = {
    ...
    # constraint.py (constrained-decoding-real-backend): the llguidance-backed byte-level
    # masking engine, in the default set with its own test selection -- taking the place
    # of logits_processor.py, which Phase 2 of the same track deleted. The default set
    # stays at six modules; see tools/README-mutate.md's "Module coverage" section.
